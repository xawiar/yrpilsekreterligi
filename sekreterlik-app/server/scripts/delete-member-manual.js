/**
 * Manuel Üye Silme Script'i
 * 
 * ⚠️ PASİFİZE EDİLDİ: Organization_id desteği kaldırıldı
 * Bu script belirli bir üyeyi TC, telefon veya isim ile bulup siler.
 * Kullanım: 
 *   node scripts/delete-member-manual.js
 */
...
async function deleteMember() {
  ...
  try {
    ...
    for (const doc of membersSnapshot.docs) {
      ...
      if (
        (decryptedTc === TARGET_TC || member.tc === TARGET_TC) ||
        (decryptedPhone === TARGET_PHONE || member.phone === TARGET_PHONE) ||
