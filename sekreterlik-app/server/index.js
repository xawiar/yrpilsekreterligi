...
const electionCoordinatorsRouter = require('./routes/electionCoordinators');
console.log('Election coordinators router imported');
const electionRegionsRouter = require('./routes/electionRegions');
console.log('Election regions router imported');
