...
const PublicElectionResultsPage = ({ electionIdProp }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Footer */}
      <div className="py-6 text-center border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 mt-8">
        <a
          href="/public/apply"
          className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition-colors shadow-sm"
        >
        ...
        <p className="mt-3 text-xs text-gray-500 dark:text-gray-400">
          Partimize katilmak icin basvuru formu doldurun
        </p>
      </div>
    </div>
  );
