                ...
                <div className="space-y-3">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="text-base font-semibold text-gray-900 mb-1">{neighborhood.name}</h3>
                      <p className="text-sm text-gray-500">{neighborhood.district_name || '-'} / {neighborhood.town_name || '-'}</p>
                    </div>
                    {hasRepresentative ? (
