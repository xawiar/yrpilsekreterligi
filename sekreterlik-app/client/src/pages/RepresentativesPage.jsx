            ...
            <>
              ...
              {filteredNeighborhoodReps.length === 0 ? (
                <EmptyState
                  ...
                  title={searchTerm ? 'Arama sonucu bulunamadı' : 'Henüz mahalle temsilcisi eklenmemiş'}
                  description={searchTerm ? 'Farklı arama terimleri deneyin.' : 'Mahalle ayarlarından temsilci ekleyebilirsiniz.'}
                />
              ) : (
                <>
                  {/* Mobile Card View */}
            ...
            <>
              ...
              {filteredVillageReps.length === 0 ? (
                <EmptyState
                  ...
                  title={searchTerm ? 'Arama sonucu bulunamadı' : 'Henüz köy temsilcisi eklenmemiş'}
                  description={searchTerm ? 'Farklı arama terimleri deneyin.' : 'Köy ayarlar��ndan temsilci ekleyebilirsiniz.'}
                />
              ) : (
                <>
                  {/* Mobile Card View */}
