    ...
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-100 dark:border-gray-700">
        <div className="flex items-center">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Ort. Katılım Oranı</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">%{stats.avgAttendanceRate}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-100 dark:border-gray-700">
        <div className="flex items-center">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Toplam Etkinlik</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.totalEvents || 0}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-100 dark:border-gray-700">
        <div className="flex items-center">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Mahalle Temsilcileri</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.totalNeighborhoodRepresentatives || 0}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 border border-gray-100 dark:border-gray-700">
        <div className="flex items-center">
          ...
          <div>
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Köy Temsilcileri</p>
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.totalVillageRepresentatives || 0}</p>
          </div>
        </div>
      </div>
    </div>
