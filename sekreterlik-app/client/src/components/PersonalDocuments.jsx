...
const PersonalDocuments = ({ memberId }) => {
  ...
  const isImageMime = (mime) => mime === 'image/jpeg' || mime === 'image/png';
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500">
                PDF, JPG veya PNG dosyaları kabul edilir. Maksimum dosya boyutu: 10MB
              </p>
            </div>
              ...
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0">
                  {isImageMime(document.mime_type) ? (
                    <div className="w-10 h-10 bg-emerald-100 rounded-lg flex items-center justify-center" title="Resim">
                      <svg className="w-6 h-6 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                    </div>
                  ) : (
                    <div className="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center" title="PDF">
