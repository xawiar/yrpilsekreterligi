    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            onClick={handleResetAllAuth}
            disabled={isResettingAllAuth}
            className="bg-amber-500 hover:bg-amber-600 disabled:bg-gray-400 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-200 flex items-center"
            title="Giriş yapamayan tüm üyelerin Firebase Auth hesaplarını Firestore şifresiyle yeniden oluşturur"
          >
            {isResettingAllAuth ? (
              <>
                <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div>
