...
const NeighborhoodsSettings = () => {
  ...
  // Filter neighborhoods by group_no
  const filteredNeighborhoods = filterGroupNo 
    ? neighborhoods.filter(n => String(n.group_no || '') === String(filterGroupNo))
    : neighborhoods;
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Mevcut Mahalleler</h3>
        ...
        {filteredNeighborhoods.length === 0 ? (
          ...
          <div className="p-4 space-y-3">
            {filteredNeighborhoods.map((neighborhood) => {
              ...
              return (
                <NativeCard key={neighborhood.id}>
          ...
          <div className="divide-y divide-gray-200 dark:divide-gray-700">
            {filteredNeighborhoods.map((neighborhood) => {
              ...
              return (
                <div key={neighborhood.id} className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">{neighborhood.name}</h4>
                        {neighborhood.group_no && (
                          <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-400">
                            Grup {neighborhood.group_no}
                          </span>
