    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Mevcut İlçeler</h3>
        </div>
        {districts.length === 0 ? (
          ...
          <div className="p-4 space-y-3">
            {districts.map((district) => {
              ...
              return (
                <NativeCard key={district.id}>
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center flex-wrap gap-2 mb-2">
                          <h4 className="text-base font-semibold text-gray-900 dark:text-gray-100">{district.name}</h4>
                    ...
                    <div className="pt-2 border-t border-gray-200 dark:border-gray-700 space-y-3">
                      {/* İlçe Başkanı */}
                      <div>
                        <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">İlçe Başkanı</div>
                        {chairman ? (
                      ...
                      {/* İlçe Müfettişi */}
                      <div>
                        <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">İlçe Müfettişi</div>
                        {inspector ? (
                          <div className="space-y-1">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-3">
                        <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{district.name}</h4>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/30 p-3 rounded-lg">
                          <h5 className="text-sm font-medium text-blue-900 dark:text-blue-400 mb-2">İlçe Başkanı</h5>
                          {chairman ? (
                            <div className="space-y-1">
                        ...
                        <div className="bg-green-50 dark:bg-green-900/30 p-3 rounded-lg">
                          <h5 className="text-sm font-medium text-green-900 dark:text-green-400 mb-2">İlçe Müfettişi</h5>
                          {inspector ? (
                            <div className="space-y-1">
