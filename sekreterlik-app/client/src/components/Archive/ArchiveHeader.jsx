...
const ArchiveHeader = ({ onUploadDocument }) => {
  return (
    <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Arşiv</h1>
        <p className="text-gray-600 mt-1">Arşivlenmiş belgeler, üyeler ve toplantılar</p>
      </div>
      <button
