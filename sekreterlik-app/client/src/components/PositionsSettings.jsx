...
const PositionsSettings = () => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition duration-300 hover:shadow-xl">
      <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Görevler</h2>
      ...
      <div className="flex mb-4">
        ...
        <button
          ...
          className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-r-lg text-sm font-medium shadow-md transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
        >
          Ekle
        </button>
      </div>
      ...
      <div className="border rounded-lg overflow-hidden shadow-sm">
        <ul className="divide-y divide-gray-200 dark:divide-gray-700">
          {positions.map((position) => (
            <li key={position.id} className="flex justify-between items-center px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150">
              {editingPosition === position.id ? (
                ...
                <>
                  <span className="text-gray-700 dark:text-gray-300">{position.name}</span>
