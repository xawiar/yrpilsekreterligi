...
const AVAILABLE_PERMISSIONS = [
  ...
  { key: 'send_bulk_sms', label: 'Toplu SMS Gönderme' },
  ...
  { key: 'access_reports_page', label: 'Raporlar Sayfası Erişimi' },
  { key: 'access_notifications_page', label: 'Bildirimler Sayfası Erişimi' },
  { key: 'access_polls_page', label: 'Anketler Sayfası Erişimi' },
  { key: 'access_teskilat_page', label: 'Teşkilat Sayfası Erişimi' },
  { key: 'access_women_branch', label: 'Kadın Kolları Erişimi' },
  { key: 'access_youth_branch', label: 'Gençlik Kolları Erişimi' },
  { key: 'access_elections_page', label: 'Seçimler Sayfası Erişimi' },
  { key: 'access_election_results', label: 'Seçim Sonuçları Erişimi' },
  { key: 'access_election_comparison', label: 'Seçim Karşılaştırma Erişimi' },
  { key: 'access_election_preparation_page', label: 'Seçim Hazırlık Sayfası Erişimi' },
  { key: 'access_ballot_boxes', label: 'Sandıklar Sayfası Erişimi' },
  { key: 'access_observers', label: 'Müşahitler Sayfası Erişimi' },
  { key: 'access_bulk_sms', label: 'Toplu SMS Sayfası Erişimi' },
